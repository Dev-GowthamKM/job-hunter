# Recording checklist — Northwind Labs, Full Stack Engineer
...
- **Title:** `Alex Rivera — Full Stack Engineer application`
- **Description:** `90 seconds on why Northwind Labs, what I've built, and where I fall short.`
- Link set to **anyone with the link can view**. A viewer hitting a login wall closes the tab.

## The message you send with it

> Hi — I've applied for the Full Stack Engineer role.
>
> Rather than another cover letter, here's 90 seconds on why Northwind Labs specifically, the system I
