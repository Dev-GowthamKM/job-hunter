# Recording checklist — Broadfin, Frontend Engineer
...
- **Title:** `Alex Rivera — Frontend Engineer application`
- **Description:** `90 seconds on why Broadfin, what I've built, and where I fall short.`
- Link set to **anyone with the link can view**. A viewer hitting a login wall closes the tab.

## The message you send with it

> Hi — I've applied for the Frontend Engineer role.
>
> Rather than another cover letter, here's 90 seconds on why Broadfin specifically, the system I
